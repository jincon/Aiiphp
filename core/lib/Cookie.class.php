...
class Cookie {
    ...
    public function get($cookieName, $default = null) {
        ...
        if ($this->_options['secretkey']) {
            $value = Aii::singleton('Encrypt')->decode($_COOKIE[$cookieName], $this->_options['secretkey']);
    ...
    public function set($cookieName, $value, $expire = null, $path = null, $domain = null) {
        ...
        if ($this->_options['secretkey']) {
            $value = Aii::singleton('Encrypt')->encode(serialize($value), $this->_options['secretkey']);
        } else {
